  ...
  return (
    <div>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <a className="nav-link custom-nav-link text-info" href="#home">
                  Home
                </a>
              </li>
              <li className="nav-item">
                <a
                  className="nav-link custom-nav-link text-info"
                  href="#features"
                >
                  Features
                </a>
              ...
              <li className="nav-item">
                <a className="nav-link custom-nav-link text-info" href="#about">
                  About Me
                </a>
              </li>
            </ul>
      ...
      >
        ...
        <div className="container">
          <h1 className="display-4 animated-heading text-info">
            Welcome to My Blog Website
          </h1>
          <hr />
          <p className="lead animated-subheading">
            Read my weekly blogs about my subjects in Advanced Networking and
          ...
          <div className="row text-center">
            <div className="col-md-4">
              <div className="feature-card p-4 shadow-sm">
                ...
                <p>
                  Read about what I have learned during the week and interesting
                  happenings throughout my learning.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="feature-card p-4 shadow-sm">
                ...
                <h4>Learn with Me</h4>
                <p>
                  You might learn something from what I’ve explored and discover
                  what interests me during discussions and activities.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="feature-card p-4 shadow-sm">
                ...
                <p>
                  Experience comfort while reading and browsing with a
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-7">
              ...
              <p className="about-text">
                Hi! I’m Alec Xander F. Espaldon a passionate BSIT student who
                loves learning and building things with code. This blog is my
                digital notebook—where I document everything I’ve been learning
                about
                <strong> Advanced Networking</strong>,{" "}
                <strong>Information Assurance & Security 1</strong>, and more.
              </p>
              <p className="about-text">
                I enjoy creating websites with clean, responsive designs and
                using modern tools like
                <strong> React</strong>, <strong>Bootstrap</strong>,{" "}
                <strong>Java</strong> and <strong>Python</strong> for backend
                logic. Let’s learn and grow together!
              </p>
            </div>
          </div>
        </div>
